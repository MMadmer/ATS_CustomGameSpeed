...
namespace CustomGameSpeed.Patches
{
    ...
    internal class PlayerPatches
    {
        ...
        {
            CustomGameSpeedPlugin.Log.LogInfo("In Player Awake method Prefix.");
            return true;
        }
        ...
        {
            CustomGameSpeedPlugin.Log.LogInfo("In Player Awake method Postfix.");
        }
    }*/
}